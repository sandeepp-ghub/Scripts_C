...
source /nfs/pt/home/lioral/scripts/service_procs/file_to_list.tcl
set ram_facrot 1.1
set util $input
...
set units [file_to_list /nfs/pt/store/project_store12/store_kw28/USERS_V/anavaf/UDS/default_area_manof/MODELS/Backend/kw28_beta_macro/mky/r5/work/neta3]
foreach un $units {

    set cells [get_cells $un/* ]
...
set cells [get_cells -regexp  {kw28_neta_cluster/[^/]*}]
# set cells [get_cells kw28_neta_cluster/*   -filter "full_name =~*/[]"]
    set cell_count_count 0
    set area       0
    set ram_count  0
    set ram_area   0
