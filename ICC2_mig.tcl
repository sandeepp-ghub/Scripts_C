...
proc drew_macro_arrow {} {
    ...
    # get memory pins.
    set pinsIN   [get_flat_pins -of $macro -filter "direction==in&&name=~D*[*]||name=~*data*||name=~*idx*||name=~A*[*]"]
    set pinsOUT  [get_flat_pins -of $macro -filter "direction==out&&name=~Q*[*]||name=~*data*||name=~*hit*"]
